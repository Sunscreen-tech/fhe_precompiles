    ...
    fn fhe_encrypt_test() -> Result<(), RuntimeError> {
        ...
        assert_eq!(
            ...
            (if cfg!(target_os = "macos") {
                ...
                [
                    225, 21, 180, 25, 197, 8, 7, 191, 90, 211, 79, 100, 172, 155, 152, 100, 7, 141,
                    142, 11, 248, 46, 97, 255, 119, 147, 48, 57, 57, 164, 60, 75, 217, 150, 66,
                    172, 252, 226, 118, 86, 176, 213, 48, 132, 190, 120, 129, 134, 99, 190, 197, 5,
                    230, 252, 55, 89, 94, 170, 140, 233, 63, 153, 65, 152,
                ]
            })
            .into()
        );
    ...
    fn fhe_reencrypt_test() -> Result<(), RuntimeError> {
        ...
        assert_eq!(
            ...
            (if cfg!(target_os = "macos") {
                ...
                [
                    22, 251, 136, 4, 141, 110, 111, 121, 181, 22, 208, 218, 148, 27, 154, 226, 138,
                    183, 237, 162, 247, 24, 13, 6, 2, 175, 96, 249, 179, 5, 58, 8, 119, 170, 171,
                    251, 71, 118, 168, 48, 58, 114, 39, 193, 220, 112, 73, 117, 7, 58, 80, 33, 182,
                    47, 17, 95, 207, 111, 234, 243, 39, 84, 124, 129,
                ]
            })
            .into()
        );
